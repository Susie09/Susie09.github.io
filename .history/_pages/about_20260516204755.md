...
# 👨‍🏫 Academic Service
- *2025.12 – present*, **Area Chair**, ACL Rolling Review (ARR) — January 2026 cycle.
- *2025.07*, **Area Chair**, ACL Rolling Review (ARR) — July 2025 cycle.
- *2023.04*, **Area Chair**, China National Conference on Computational Linguistics (CCL 2023).
- Regular reviewer for ACL, EMNLP, NAACL, NeurIPS, ICLR, AAAI, IJCAI, IEEE TASLP.
